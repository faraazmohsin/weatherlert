...
function init(resultFromServer) {
  ...
  switch (resultFromServer.weather[0].description) {
    ...
    case 'moderate rain':
    case 'light rain':
      document.body.style.backgroundImage = 'url("lightrain.svg")';
      break;
    ...
    case 'light intensity shower rain':
      document.body.style.backgroundImage = 'url("drizzle.svg")';
      break;

    case 'scattered clouds':
    case 'overcast clouds':
      document.body.style.backgroundImage = 'url("scatteredclouds.svg")';
      break;
    ...
    case 'squalls':
    case 'tornado':
      document.body.style.backgroundImage = 'url("mist.svg")';
